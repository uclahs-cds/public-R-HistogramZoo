test_that("local_min_max works on non consecutive numbers", {
  x <- c(1,2,1,4,1)
  x.minmax <- local_min_max(x)
  expect_equal(x.minmax$min.ind, c(1,3,5))
  expect_equal(x.minmax$max.ind, c(2,4))
})


test_that("local_min_max works on consecutive starting numbers", {
  x <- c(1, 1,2,1,4,1)
  x.minmax <- local_min_max(x)
...
test_that("local_min_max works on consecutive ending numbers", {
  x <- c(1,2,1,4,1, 1)
  x.minmax <- local_min_max(x)
  expect_equal(x.minmax$min.ind, c(1,3,5))
  expect_equal(x.minmax$max.ind, c(2,4))
...
test_that("local_min_max works on consecutive starting and ending numbers", {
  x <- c(1, 1,2,1,4,1, 1)
  x.minmax <- local_min_max(x)
  expect_equal(x.minmax$min.ind, c(2,4,6))
  expect_equal(x.minmax$max.ind, c(3,5))
...
test_that("local_min_max works on even consecutive numbers in middle of sequence", {
  x <- c(1,2,2,1,1,4,4, 1)
  x.minmax <- local_min_max(x)
...
test_that("local_min_max works on odd consecutive numbers in middle of sequence", {
