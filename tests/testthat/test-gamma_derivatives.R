...
test_that("gamma", {
  ...
  expect_equal(
    pgamma(qgamma(seq(0, 0.9, 0.1), shape = 10, shift = 20), shape = 10, shift = 20),
    seq(0, 0.9, 0.1)
  )
...
test_that("tgamma", {
  ...
  # rtgamma
  expect_error(
    rtgamma(10000, shape = 10, a = 5, b = 20),
    NA
  )

  # dtgamma - tested below
  ...
  expect_equal(
    ptgamma(qtgamma(seq(0, 0.9, 0.1), shape = 10, a = 5, b = 20, shift = 10), shape = 10, a = 5, b = 20, shift = 10),
    seq(0, 0.9, 0.1)
  )
...
test_that("tgamma_flip ", {
  ...
  # dtgamma_flip
  dtgamma_data <- dtgamma(5:20, shape = 10, a = 5, b = 20, shift = 5)
  dtgamma_flip_data <- dtgamma_flip(5:20, shape = 10, a = 5, b = 20, offset = 20)
  ...
  # ptgamma_flip
  ptgamma_data <- ptgamma(5:20, shape = 10, a = 5, b = 20, shift = 5)
  ptgamma_flip_data <- ptgamma_flip(rev(5:20), shape = 10, lower.tail = F, a = 5, b = 20, offset = 20)
  ...
  expect_equal(
    ptgamma_flip(qtgamma_flip(seq(0, 0.9, 0.1), shape = 10, a = 5, b = 20, offset = 20), shape = 10, a = 5, b = 20, offset = 20),
    seq(0, 0.9, 0.1)
  )
